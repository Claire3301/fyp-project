function result=Heston_SZ2(K,delta,exact,scheme)
    ...
    for j=1:M
        for i=1:N
            ...
            switch scheme
                ...
                case 1
                    xx2=xx1-1/2*v1^2*delta+v1*sqrt(delta)*(rho_xv*randn()+sqrt(1-rho_xv^2)*randn());
                case 2
                    xx2=xx1-1/2*(delta1*v1^2+delta2*v2^2)*delta+rho_xv*v1*sqrt(delta)*randn()+...
